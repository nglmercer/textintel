...
pub fn readings_for_token(token: &str, max_readings: usize) -> Vec<SymbolReading> {
    ...
    let values: Vec<SymbolReading> = match token {
        ...
        "0" => vec![
            reading("cero", "es", 0.80, "number_reading"),
            reading("zero", "en", 0.70, "number_reading"),
            reading("o", "und", 0.50, "number_reading"),
        ],
        "1" => vec![
            reading("uno", "es", 0.80, "number_reading"),
            reading("one", "en", 0.70, "number_reading"),
            reading("un", "es", 0.50, "number_reading"),
            reading("i", "und", 0.40, "number_reading"),
        ],
        "2" => vec![
            reading("dos", "es", 0.90, "number_reading"),
            reading("two", "en", 0.70, "number_reading"),
            reading("tu", "es", 0.30, "number_reading"),
        ],
        "3" => vec![
            reading("tres", "es", 0.85, "number_reading"),
            reading("three", "en", 0.70, "number_reading"),
            reading("e", "und", 0.35, "number_reading"),
        ],
        "4" => vec![
            reading("cuatro", "es", 0.70, "number_reading"),
            reading("four", "en", 0.60, "number_reading"),
            reading("a", "und", 0.55, "number_reading"),
            reading("for", "en", 0.40, "number_reading"),
        ],
        "5" => vec![
            reading("cinco", "es", 0.70, "number_reading"),
            reading("five", "en", 0.60, "number_reading"),
            reading("s", "und", 0.40, "number_reading"),
        ],
        "6" => vec![
            reading("seis", "es", 0.70, "number_reading"),
            reading("six", "en", 0.60, "number_reading"),
        ],
        "7" => vec![
            reading("siete", "es", 0.70, "number_reading"),
            reading("seven", "en", 0.60, "number_reading"),
            reading("t", "und", 0.30, "number_reading"),
        ],
        "8" => vec![
            reading("ocho", "es", 0.70, "number_reading"),
            reading("eight", "en", 0.60, "number_reading"),
            reading("ate", "en", 0.35, "number_reading"),
        ],
        "9" => vec![
            reading("nueve", "es", 0.70, "number_reading"),
            reading("nine", "en", 0.60, "number_reading"),
        ],
        "10" => vec![
            reading("diez", "es", 0.80, "number_reading"),
            reading("ten", "en", 0.70, "number_reading"),
        ],
        "100" => vec![
...
pub fn concepts_for_token(token: &str) -> Vec<SymbolConcept> {
    match token {
        ...
        token if token.chars().all(char::is_numeric) => vec![SymbolConcept {
            id: "number".to_string(),
            probability: 0.80,
        }],
        _ => Vec::new(),
